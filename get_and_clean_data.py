...
stats_filepath = "/Users/nishantvellanki/Documents/NBA_MVP_Prediction/NBA_stats_including_MVP.csv"
mvp1_filepath = "/Users/nishantvellanki/Documents/NBA_MVP_Prediction/mvp_data/2001-2010 MVP Data.csv"
mvp2_filepath = "/Users/nishantvellanki/Documents/NBA_MVP_Prediction/mvp_data/2010-2021 MVP Data.csv"
mvp3_filepath = "/Users/nishantvellanki/Documents/NBA_MVP_Prediction/mvp_data/2022-2023 MVP Data.csv"
...
if not os.path.exists('clean_mvp_data/cleaned_full_stats.csv'): # save to a new file only once
    full_stats_pd.to_csv('clean_mvp_data/cleaned_full_stats.csv', index=False)
...
if not os.path.exists('clean_mvp_data/cleaned_first_mvp_set.csv'): # save to a new file only once
    mvp1_pd.to_csv('clean_mvp_data/cleaned_first_mvp_set.csv', index=False)
...
if not os.path.exists('clean_mvp_data/cleaned_second_mvp_set.csv'):
    mvp2_pd.to_csv('clean_mvp_data/cleaned_second_mvp_set.csv', index=False)
...
if not os.path.exists('clean_mvp_data/cleaned_third_mvp_set.csv'):
    mvp3_pd.to_csv('clean_mvp_data/cleaned_third_mvp_set.csv', index=False)
...
full_stats_pd = pd.read_csv('clean_mvp_data/cleaned_full_stats.csv')
